...
const Home=()=>{
    ...
    // Filter items based on selected category, diet, and search term
    const filteredMenu = foodMenu.filter((item) => {
        ...
        const matchDiet = selectedDiet === 'All' || (selectedDiet === 'veg' ? item.isVeg : !item.isVeg);
        const matchSearch = appliedSearchTerm === '' || item.name.toLowerCase().includes(appliedSearchTerm.toLowerCase());
        ...
        <div className='home-container'>
            <div className='home-header-container'>
                <div className='home-header'>
                    <h1 className='logo'>Party Menu</h1>
                    <p className='welcome-message'>Welcome, {userName}</p>
                </div>
                <div className='home-content'>
                    <button className='home-button' onClick={handleSavedRecipes}>
                        Saved Recipes {savedCount===0?'':savedCount}
                      </button>
                    
                    <button className='home-button' onClick={onClickLogout}>Logout</button>
            ...
            <div className='home-body'>
                <div className='home-body-Category'>
                    ...
                    <div className='home-body-category-buttons'>
                        <button 
                            className={`home-body-category-button ${selectedCategory === 'All' ? 'active' : ''}`}
                            onClick={() => setSelectedCategory('All')}
                        >
                            All
                        </button>
                        <button 
                            className={`home-body-category-button ${selectedCategory === 'Starter' ? 'active' : ''}`}
                            onClick={() => setSelectedCategory('Starter')}
                        >
                            Starter
                        </button>
                        <button 
                            className={`home-body-category-button ${selectedCategory === 'Main' ? 'active' : ''}`}
                            onClick={() => setSelectedCategory('Main')}
                        >
                            Main
                        </button>
                        <button 
                            className={`home-body-category-button ${selectedCategory === 'Sides' ? 'active' : ''}`}
                            onClick={() => setSelectedCategory('Sides')}
                        >
                            Sides
                        </button>
                        <button 
                            className={`home-body-category-button ${selectedCategory === 'Desert' ? 'active' : ''}`}
                ...
                <div className='home-body-Diet'>
                    <h1 className='Diet'>DIET</h1>
                    <div className='home-body-diet-buttons'>
                        <button 
                            className={`home-body-diet-button ${selectedDiet === 'All' ? 'active' : ''}`}
                            onClick={() => setSelectedDiet('All')}
                        >
                            All
                        </button>
                        <button 
                            className={`home-body-diet-button ${selectedDiet === 'veg' ? 'active' : ''}`}
                            onClick={() => setSelectedDiet('veg')}
                        >
                            veg
                        </button>
                        <button 
                            className={`home-body-diet-button ${selectedDiet === 'non-veg' ? 'active' : ''}`}
                ...
                <div className='home-body-search'>
                    <input 
                        ...
                        className='home-body-search-input'
                        value={searchInputValue}
                        onChange={(e) => setSearchInputValue(e.target.value)}
                    />
                    <button className='home-body-search-button' onClick={handleSearch}>Search</button>
                </div>
                
            </div>
            <div>
                <h1 className="item-found">{filteredMenu.length} Items found</h1>
            </div>
